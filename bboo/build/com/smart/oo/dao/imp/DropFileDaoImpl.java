...
@Repository("BBOODropFileDaoImpl")
public class DropFileDaoImpl extends BaseDAO<DropFileEntity, String> implements
		IDropFileDao {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2139446531269498810L;

	@Override
	public String saveData(DropFileEntity tickes) throws Exception {
		// TODO Auto-generated method stub
		return this.save(tickes);
	}

	@Override
	public int updateData(DropFileEntity ticket) throws Exception {
		// TODO Auto-generated method stub
		List<Object> params = new ArrayList<Object>();
		StringBuffer buf = new StringBuffer("update DropFileEntity set id=?");
	...
	@Override
	public List<DropFileEntity> findDatas(DropFileEntity ticket, Page p)
			throws Exception {
		// TODO Auto-generated method stub
		List<Object> params = new ArrayList<Object>();
		StringBuffer buf = new StringBuffer("from DropFileEntity where 1=1");
		if (StringUtils.isNotEmpty(ticket.getFileName())) {
	...
	@Override
	public List<DropFileEntity> findDatas(DropFileEntity ticket)
			throws Exception {
		// TODO Auto-generated method stub
		List<Object> params = new ArrayList<Object>();
		StringBuffer buf = new StringBuffer("from DropFileEntity where 1=1");
