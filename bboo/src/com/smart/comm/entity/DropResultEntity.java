...
@Entity
@Table(name = "t_drop_result")
public class DropResultEntity extends BBOOObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = 9022284943002959445L;
	@Id
	@Column(name = "id", unique = true, nullable = false, precision = 10, scale = 0, length = 80)
	private String id;
	/**
	 * SZXPEKCA54822016-09-30Y
	 */
	@Column(name = "indexKey", length = 35)
	 ...
	 * QUA GDS AIRGW CTRIP
	 */
	@Column(name = "queryWay", length = 15)
	...
	@Column(name = "ATime", length = 20)
	private String ATime;
	@Column(name = "cabin", length = 10)
	private String cabin;
	@Column(name = "seatnum", length = 5)
	...
	@Column(name = "LCabin", length = 10)
	private String LCabin;
	@Column(name = "LFare")
	private Double LFare;
	@Column(name = "LReturnRate")
	private Double LReturnRate;
	@Column(name = "LRefund")
	private Double LRefund;
	@Column(name = "LSeatnum", length = 5)
	private String LSeatnum;
	...
	public void setLCabin(String lCabin) {
		LCabin = lCabin;
	}

	public Double getLFare() {
		return LFare;
	}

	public void setLFare(Double lFare) {
		LFare = lFare;
	}

	public Double getLReturnRate() {
		return LReturnRate;
	}

	public void setLReturnRate(Double lReturnRate) {
		LReturnRate = lReturnRate;
	}

	public Double getLRefund() {
		return LRefund;
	}

	public void setLRefund(Double lRefund) {
		LRefund = lRefund;
	}

	public String getLSeatnum() {
		return LSeatnum;
	}

	public void setLSeatnum(String lSeatnum) {
		LSeatnum = lSeatnum;
	}
