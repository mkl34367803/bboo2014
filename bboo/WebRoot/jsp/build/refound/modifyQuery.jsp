...
<script src="${ctx }/static/js/build/refund/modifyQuery.js" type="text/javascript"></script>
		...
		<table class="m-search g-clear g-table" style="width: 100%">
			...
			<tr class="rows">
				...
				<td class="col">
					...
					<div class="label-info">
						<label> <input name="searchState" value="1" type="radio" class="g-input-check" checked="checked">退票 </label> 
						<label> <input name="searchState" value="2" type="radio" class="g-input-check">留票 </label> 
					</div>
				</td>
			</tr>
			<tr class="rows">
