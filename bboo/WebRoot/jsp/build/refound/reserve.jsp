...
<script type="text/javascript" src="${ctx }/static/js/build/refund/reserve.js"></script>
<style type="text/css">
body {
	min-width: 800px;
	padding-right: 20px;
				...
				<div class="refoundDiv psgRefund" style="margin-bottom: 10px;">
					...
					<div class="g-content" style="margin-bottom: 10px">
						<table class="g-table table-list" >
							...
							<tbody class="table-bd">
								<tr>
									...
									<c:forEach items="${orderDetail.flights}" var="flight" varStatus="i" end="0" >
										<td><input name="face" value="${refund.face2 }" type="text" onkeyup="caculate('')" /></td>
										<td><input name="baseFace" value="${refund.baseFace2 }" type="text" onkeyup="caculate('')" /></td>
										<td><input name="yq" value="${refund.yq2 }" type="text" onkeyup="caculate('')" /></td>
										<td><input name="tax" value="${refund.tax2 }" type="text" onkeyup="caculate('')" /></td>
										<td><input name="rate" value="${refund.rate2 }" type="text" onkeyup="caculate('')" /></td>
									<script type="text/javascript">
							...
							<tbody class="table-bd">
								<tr>
									<td><input name="fee" value="${refund.fee2 }" type="text" onkeyup="caculateByFee('')" /></td>
